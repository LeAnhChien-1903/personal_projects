...
namespace astar_planner_ros
{
	...
	{
    this->node.getParam("/map_topic",this->map_topic);
    this->node.getParam("/amcl_topic",this->amcl_topic);
    this->node.getParam("/goal_topic", this->goal_topic);
    this->node.getParam("/global_path_topic", this->global_path_topic);
    this->node.getParam("/origin", this->original_position);
    this->node.getParam("/resolution", this->resolution);
    this->node.getParam("/global_frequency", this->frequency);
