...
Point2DPixel::Point2DPixel(double x, double y, double origin_x, double origin_y, double resolution, int map_height_pixel)
{
	this->x = contxy2disc(x - origin_x, resolution);
	this->y = map_height_pixel - contxy2disc(y-origin_y, resolution);
}
Twist::Twist()
{
	this->linear = 0.0;
